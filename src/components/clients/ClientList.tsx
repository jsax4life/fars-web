          ...
          <div className="py-1">
            ...
            >
              View Details
                  ...
                  <Link
                    href={`/ClientAccounts?clientId=${selectedUserForAction.id}`}
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                  >
                    View Accounts
                  </Link>
                  ...
                  <button
                    onClick={() =>
                      handleCreateReportClick(selectedUserForAction)
                    }
                    className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left"
                  >
                    Create Report
                  ...
                  <button
                    onClick={() => setDeleteUser(selectedUserForAction)}
            ...
            <div className="px-4 py-3 bg-white border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-gray-700">
                ...
                <span className="font-medium">
                  {Math.min((page + 1) * 10, users.length)}
                </span>{" "}
                of <span className="font-medium">{users.length}</span> entries
              </div>
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  onClick={() =>
                    setPage((prev) =>
                      Math.min(prev + 1, Math.ceil(users.length / 10) - 1)
                    )
                  }
                >
                  Next
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setViewedUser({ ...viewedUser, email: e.target.value })
                      }
                      className="w-full px-3 py-2 text-gray-600 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#F36F2E]"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setViewedUser({ ...viewedUser, phone: e.target.value })
                      }
                      className="w-full px-3 py-2 text-gray-600 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#F36F2E]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setViewedUser({ ...viewedUser, state: e.target.value })
                      }
                      className="w-full px-3 py-2 text-gray-600 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#F36F2E]"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setViewedUser({ ...viewedUser, city: e.target.value })
                      }
                      className="w-full px-3 py-2 text-gray-600 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#F36F2E]"
                    />
                  </div>
